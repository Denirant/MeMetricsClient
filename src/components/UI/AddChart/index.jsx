...
const AddChart = ({onClose}) => {
    ...
    async function searchShops(brand, nomination){
        try{
            const {data: res} = await axios.post('http://109.248.11.166:8080/charts/lineChart/get/shops', {nomination: nomination, brand: brand, email: localStorage.getItem('email')})
    ...
    async function handleChartAdd(event){
        ...
        try{
            ...
            const {data: res} = await axios.post('http://109.248.11.166:8080/charts/lineChart/add', data);
